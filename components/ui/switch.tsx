    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          ...
          isDark
            ? 'data-[state=checked]:translate-x-4 data-[state=checked]:bg-black data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-[#666666]'
            : 'data-[state=checked]:translate-x-4 data-[state=checked]:bg-white data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-gray-500'
        )}
      />
    </SwitchPrimitives.Root>
  )
